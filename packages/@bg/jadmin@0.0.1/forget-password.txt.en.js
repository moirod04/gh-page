      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "send": "Send",
            "verify": "VERIFY",
            "userRegister": "User is not registered",
            "success": "An email has been sent to your email with the steps to recover your password",
            "subtitle": "Enter your email to retrieve your password. You will receive an email with instructions."
          };
        }
      });
