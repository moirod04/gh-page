      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "title": "User profile",
            "sureLogout": "Are you sure want to log out?",
            "passwordError": "The password does not match",
            "currentPasswordError": "Incorrect password",
            "samePassword": "The new password must be diferent to the previous one",
            "successPassword": "Password successfully changed",
            "error": "An error has occurred",
            "successfully": "Data successfully changed",
            "information": "The password must contain a minimum of 8 characters, at least one (1) uppercase, one (1) lowercase, one (1) numeric value and one (1) special character."
          };
        }
      });
