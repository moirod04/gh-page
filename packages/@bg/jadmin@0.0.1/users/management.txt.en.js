      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "profile": "profile",
            "save": "Save",
            "errorForm": "The user is already registered",
            "error": "Ha ocurrido un error",
            "toast": {
              "create": "User created successfully",
              "edit": "User edited correctly"
            },
            "userType": "User type",
            "active": "Active",
            "inactive": "Inactive",
            "invalidEmail": "The email does not match the form username@host.domain, please check it.",
            "invalidPermisions": "You do not have the necessary permissions to perform this action.",
            "cancelModal": {
              "title": "Cancel?",
              "description": "Are you sure you want to cancel? All the information you have entered so far will be lost."
            },
            "cancel": "Cancel"
          };
        }
