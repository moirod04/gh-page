      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "password": "Password",
            "email": "Email",
            "login": "Enter a new password",
            "error": "An error has occurred",
            "forgetPassword": "Trouble logging in? or have you forgotten your password",
            "success_recoverPassword": "Password changed successfully",
            "notRegister": "Incorrect username or password",
            "noSession": "Session expired, please log in again",
            "init": "Start",
            "remember": "Remember me",
            "confirm": "Confirm",
            "titleModal": "Excellent!",
            "invalidEmail": "The email does not match the format username@host.domain, please verify it",
            "newPassword": "New password",
            "confirmPassword": "Confirm password",
            "subTitle": "Complete the following information",
            "accept": "Accept",
            "cancel": "Cancel",
            "notMath": "Passwords do not match",
            "lengthPassword": "La contraseña debe tener al menos 8 caracteres",
            "invalidToken": "The link has already been used, generate a new one.",
            "somethingWentWrong": "Something went wrong, try it again later",
            "tokenExpired": "The link used to access is not valid or has expired",
            "close": "Close"
          };
        }
      });
