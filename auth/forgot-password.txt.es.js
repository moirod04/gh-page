      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "success": "Se ha enviado un mail a {{email}} con un link al que debe acceder para generar una nueva contraseña",
            "userRegister": "No existe el nombre de usuario {{username}}",
            "verify": "Aceptar",
            "subtitle": "Complete los siguientes datos.",
            "send": "RENVIAR",
            "captcha": "Captcha",
            "noMatch": "El código introducido no coincide con la imagen, inténtelo nuevamente",
            "cancel": "Cancelar",
            "close": "Cerrar",
            "aDError": {
              "pretext": "Atención:",
              "title": "El usuario pertenece al Active Directory de Santillana.",
              "instructions": "Para poder recuperar la contraseña debe contactarse a {{email}} y solicitar el cambio de contraseña.",
              "apologies": "Disculpe las molestias.",
              "from": "Equipo de MAF."
            }
          };
        }
