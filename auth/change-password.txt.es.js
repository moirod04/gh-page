      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "login": "Ingresar una nueva contraseña",
            "error": "Ha ocurrido un error",
            "forgetPassword": "¿Problemas para ingresar? o has olvidado tu contraseña",
            "success_recoverPassword": "Ya puede ingresar al sistema con su nueva contraseña",
            "notRegister": "Usuario o clave incorrectos",
            "noSession": "Sesión vencida, por favor inicie sesión nuevamente",
            "init": "Iniciar",
            "remember": "Recuérdame",
            "confirm": "Confirmar",
            "titleModal": "¡Excelente!",
            "invalidEmail": "El email no coincide con la forma username@host.dominio, verifíquelo",
            "newPassword": "Nueva contraseña",
            "confirmPassword": "Confirmar contraseña",
            "subTitle": "Complete los siguientes datos",
            "accept": "Aceptar",
            "cancel": "Cancelar",
            "notMath": "Las contraseñas no coinciden",
            "lengthPassword": "La contraseña debe tener al menos 8 caracteres",
            "invalidToken": "El enlace ya fue utilizado, genere uno nuevo.",
            "somethingWentWrong": "Algo salio mal, intentelo nuevamente mas tarde",
            "tokenExpired": "El link usado para acceder no es válido o ha expirado",
            "close": "Cerrar"
          };
        }
      });
