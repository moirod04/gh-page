      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "success": "An email has been sent to {{email}} with a link that you must access to generate a new password.",
            "userRegister": "User {{username}} not registered",
            "verify": "Accept",
            "subtitle": "Complete the following information.",
            "send": "SEND",
            "captcha": "Captcha",
            "noMatch": "The code entered does not match the image, please try again",
            "cancel": "Cancel",
            "close": "Close",
            "aDError": {
              "pretext": "Attention:",
              "title": "The user belongs to the Santillana Active Directory.",
              "instructions": "To recover the password, you must contact {{email}} and request a password change.",
              "apologies": "We apologize for the inconvenience.",
              "from": "MAF Team."
            }
          };
        }
